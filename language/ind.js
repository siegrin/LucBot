...
${bi}${prefix+command} logobuy
${bi}${prefix+command} listhargatoup
${bi}${prefix+command} pixelartbuy
${bu}\n`
}

exports.pixelartbuy = (prefix, command, dev, numbernye) => { 
...
exports.virtex = (prefix, command, dev, numbernye) => { 
return `*╭─❲ WELCOME OWNER ❳*
${bi}${prefix+command} teks
${bi}${prefix+command} troli
${bi}${prefix+command} catalog
${bu}\n`
}
...
exports.inventory = (pushname, prefix, sender, getLevelingXp, getLevelingLevel, checkHealuser, heartbars, checkLimituser, potionpointa, megapotionpointa, uangku, reqXp, role, prema, player, tampilHari) => {
return `
