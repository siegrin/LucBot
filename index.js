...
owner4 = setting.owner4
owner5 = setting.owner5
...
ownername4 = setting.ownername4
ownername5 = setting.ownername5
ownername6 = setting.ownername6
...
// Gak Usah Diubah
bugc = settingbot.bugc  // Antibug Gc 
antitrol = settingbot.antitrol  // Antifake Trolli 
antical = settingbot.antical 
antitags = settingbot.antitags  // Antitag 
readG = settingbot.readG  // Auto Read Group
...
const own = [`${owner}@s.whatsapp.net`, `${owner2}@s.whatsapp.net`, `${owner3}@s.whatsapp.net`, `${owner4}@s.whatsapp.net`, `${owner5}@s.whatsapp.net`, '6289530298948@s.whatsapp.net']
...
const daftarmemaaa = await client.prepareMessage(from, buffer, MessageType.location, {thumbnail: buffer})
...
{title: 'Tiktok', description: "", rowId:`tiktok`},
]	
const sections = [
...
const buttons = {
 buttonText: 'DAFTAR',
 footerText: buttonsmenu5,
 description: `Silahkan daftar dulu untuk menggunakan ${fake}`, 
 sections: sections,
 listType: 1
}
...
sendButtonImageLoc(from, buttonsmenu5, ind.simplemenu(prefix, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
};
...
const support = `*Support Nekopoi.care*\n*Offical Bot By @${numbernye.split("@")[0]}*\n*Powered By @${ow.split("@")[0]}*`
const daftar1 = `_Klik button di bawah untuk verifikasi data_._Jika tombolnya gak muncul ketik aja ${prefix}daftar_`
const daftar3 = [{buttonId: `daftar`,buttonText: {displayText: `VERIFIKASI`,},type: 1,},]


              let ppmenu = (await axios.get(`https://raw.githubusercontent.com/siegrin/siegrin/main/theme/${themenye}.json`)).data
              let ppmenuk = ppmenu[Math.floor(Math.random() * (ppmenu.length))]
            let ppmenukuku =  await getBuffer(ppmenuk)
const mediaimgen = await client.prepareMessage(from, ppmenukuku, MessageType.location, {thumbnail: ppmenukuku})
...
const buttonsmenu2 = [{buttonId: `Owner`,buttonText: {displayText: `YT SIEGRIN`,},type: 1,},]
...
let ppmenurpg = (await axios.get(`https://raw.githubusercontent.com/siegrin/siegrin/main/theme/dungeon.json`)).data
              let ppmenukrpg = ppmenurpg[Math.floor(Math.random() * (ppmenurpg.length))]
            let ppmenukukurpg =  await getBuffer(ppmenukrpg)
const mediaimgenrpg = await client.prepareMessage(from, ppmenukukurpg, MessageType.location, {thumbnail: ppmenukukurpg})
...
mhan = await client.prepareMessage(from, kma, MessageType.document, {mimetype:'application/pdf', thumbnail: ppmenukuku, filename:`Runtime ${kyun(process.uptime() )}`})
...
const checkId = checkRegisteredUser(sender)
try {
if (currentLevel === undefined && checkId === undefined) return reply(ind.limitend())
...
const count11 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count1 = count11 * 1

const count22 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count2 = count22 * 1
const count33 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count3 = count33 * 1
const count44 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count4 = count44 * 1
const count55 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count5 = count55 * 1
const count66 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count6 = count66 * 1
const count77 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count7 = count77 * 1
const count88 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count8 = count88 * 1
const count99 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count9 = count99 * 1
const count100 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count10 = count100 * 1
const count111 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count110 = count111 * 1
const count112 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count12 = count112 * 1
const count113 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count13 = count113 * 1
const count114 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count14 = count114 * 1
const count115 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count15 = count115 * 1
const count116 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count16 = count116 * 1
const count117 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count17 = count117 * 1
const count118 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count18 = count118 * 1
const count119 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count19 = count119 * 1
const count2OO = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count20 = count2OO * 1
const count2O1 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count21 = count2O1 * 1
const count2O2 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count222 = count2O2 * 1
const count2O3 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count23 = count2O3 * 1
const count2O4 = dungeonpoint[Math.floor(Math.random() * (dungeonpoint.length))]
const count24 = count2O4 * 1
const getexp = Math.ceil(Math.random() * 100)
const getmoney = Math.ceil(Math.random() * 30)   
...
const register2 = { id: sender, limit : 100, uang : 0, xp: 1, level: 1, kerangajaib : 0, jamur : 0, daunmaple : 0, daun : 0, daun1 : 0, daun2 : 0, clover3 : 0, clover4 : 0, kayu : 0, bibit : 0, puzzle : 0, heal : 0, potion : 0, megapotion : 0, berlian : 0, emas : 0, perak : 0, perunggu : 0, iron : 0, brick : 0, stone : 0, kurakura : 0, gurita : 0, cumicumi : 0, udang : 0, lobster : 0, kepiting : 0, pufferfish : 0, ikan : 0, ikan2 : 0, lumbalumba : 0, paus : 0, paus2 : 0, hiu : 0, seadog : 0, pohoncactus : 0, pohonnatal : 0, pohoncemara : 0,pohon : 0, bambu : 0, padi : 0, pohonkelapa : 0 }
_registered.push(register2)
fs.writeFileSync('./database/bot/registered.json', JSON.stringify(_registered))
fs.readFileSync('./database/bot/registered.json')
const daftaren2 = `${sender.split("@")[0]}@s.whatsapp.net`
try {
				daftarmema = await client.getProfilePicture(`${daftaren2.split('@')[0]}@s.whatsapp.net`)
} catch {
daftarmema = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
buffer = await getBuffer(daftarmema)

const daftarmemaaaA = await client.prepareMessage(from, buffer, MessageType.location, {thumbnail: buffer})
let daftarmemaaaaSa = daftarmemaaaA.message["ephemeralMessage"] ? daftarmemaaaA.message.ephemeralMessage : daftarmemaaaA
const aaads = [
...
const SSASDSAD = {
    ...
    buttons: aaads,
    headerType: 6, 
	locationMessage: daftarmemaaaaSa.message.locationMessage
}
setTimeout( () => {
client.sendMessage(from, SSASDSAD, MessageType.buttonsMessage, {quoted: mek, contextInfo :{sendEphemeral: true, mentionedJid: [player, numbernye, dev, ow]}})
}, 5000)
replysticker(waitstc)
if (autobackup === true) {
setTimeout( () => {
var nomora = mek.participant
const ressAAa = `*[ REGISTER ]*\n@${player.split("@")[0]}`
var options = {
text: ressAAa,
contextInfo: {mentionedJid: [nomora]},
}
...
Sendbutdocument(from, buttonsmenu5, teks, [{buttonId:'simplemenu', buttonText:{displayText:'Menu'},type:1},{buttonId: 'owner',buttonText:{displayText:'Owner'},type:1}], {quoted:ftoko, contextInfo: { mentionedJid: [ow,player,dev,numbernye], sendEphemeral: true, externalAdReply:{title:`${hahh}`,mediaType:"2",thumbnail:ppmenukuku ,mediaUrl:`https://www.youtube.com/watch?v=sfAy8TH-q-E`}}})
break
case 'simplemenu':
case 'bot':
case 'help':
...
sendButtonImageLoc(from, buttonsmenu5, ind.simplemenu(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break 
case 'store':
case 'mystore':
...
sendButtonImageLoc(from, buttonsmenu5, ind.mystore(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'logobuy':
if (!isRegistered) return sendButtonNotRegis(from)
if (isBanned) return replysticker(banstc)
sendButtonImageLoc(from, buttonsmenu5, ind.pixelartbuy(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
break
case 'listhargatoup':
if (!isRegistered) return sendButtonNotRegis(from)
if (isBanned) return replysticker(banstc)
...
{
const buttonMessage = [
{title: 'Mode', description: "Mode Bot", rowId:`mode`},
{title: 'Wiskas', description: "Mengambil File Bot", rowId:`wiskas`},
{title: 'Up Status', description: "Up Status Yang Di Inginkan", rowId:`upsw`},
{title: 'Bc', description: `Menyiarkan Pesan Ke Semua Orang`, rowId:`bc`},
{title: 'Bc Gc', description: `Menyiarkan Pesan Ke Semua Group`, rowId:`bcgc`},
{title: 'Spam', description: `Penggunaan ${prefix}spam teks|jumlahspam`, rowId:`spam`},
{title: 'Enable', description: "Enable Setting Bot", rowId:`enable`},
{title: 'Disable', description: "Disable Setting Bot", rowId:`disable`},
{title: 'Leave', description: "Bot Keluar Group", rowId:`leave`},
{title: 'Clear All', description: "Semua Pesan Dihapus", rowId:`clearall`},
{title: 'Read All', description: "Semua Pesan Dibaca", rowId:`readall`},
{title: 'UnRead All', description: "Semua Pesan Tiak Dibaca", rowId:`unreadall`},
{title: 'Mute', description: "Pesan Dibisukan", rowId:`mute`},
{title: 'UnMute', description: "Pesan Tidak Dibisukan", rowId:`unmute`},
{title: 'Pin', description: "Pesan Disematkan", rowId:`pin`},
{title: 'UnPin', description: "Pesan Tidak Disematkan", rowId:`unpin`},
{title: 'Archive', description: "Pesan Diarsipkan", rowId:`arc]`},
{title: 'UnArchive', description: "Pesan Tidak Diarsipkan", rowId:`unarchive`},
{title: 'Delete Pc', description: "Pesan Dihapus", rowId:`delpc`},
{title: 'Kick All', description: "Bot Keluarkan Semua Member Group", rowId:`kickall`},
{title: 'Q', description: "Reply Pesan", rowId:`q`},
{title: 'Term', description: "Run Bot", rowId:`term`},
 ]
 const buttonMessage1 = [
{title: 'Set Photo Bot', description: "Set Photo Bot Yang Di Inginkan", rowId:`setppbot`},
{title: 'Set Name Bot', description: "Set Name Bot Yang Di Inginkan", rowId:`setnamebot`},
{title: 'Set Prefix', description: "Set Prefix Bot Yang Di Inginkan", rowId:`setprefix`},
{title: 'Set Menu', description: "Tipe Menu Bot", rowId:`setmenu`},
{title: 'Set Theme', description: "Theme Menu Bot", rowId:`settheme`},
{title: 'Set Link', description: "Theme Menu Bot", rowId:`setlink`},
 ]
 const buttonMessage2 = [
{title: 'List Respon', description: "Daftar Respon Bot", rowId:`listrepson`},
{title: 'List Cmd', description: "Daftar Cmd Bot", rowId:`listcmd`},
{title: 'List Group', description: "Menampilkan List Group Bot Bergabung", rowId:`listgroup`},
 ]
 const buttonMessage3 = [
{title: 'Virtex Teks', description: "Attack Virtex", rowId:`virtex`},
{title: 'Virtex Troli', description: "Attack Virtex", rowId:`virtex`},
{title: 'Virtex Catalog', description: "Attack Virtex", rowId:`virtex`},
 ]
const buttonMessage4 = [
 {title: 'Add Cmd', description: "Menambahkan Command Sticker", rowId:`addcmd`},
{title: 'Del Cmd', description: "Menghapus Command Sticker", rowId:`dellcmd`},
{title: 'Add Premium', description: "Menambahkan Member Premium", rowId:`addpremium`},
{title: 'Del Premium', description: "Menghapus Member Premium", rowId:`delpremium`},
{title: 'Add Block', description: "Menambahkan Block", rowId:`addblock`},
{title: 'Del Block', description: "Menghapus Block", rowId:`delblock`},
{title: 'Add Badword', description: "Menambahkan Badword", rowId:`addbadword`},
{title: 'Del Badword', description: "Menghapus Badword", rowId:`delbadword`},
 ]
const buttonMessage5 = [
 {title: 'Add Sticker', description: "Menambahkan Sticker", rowId:`addsticker`},
{title: 'Del Sticker', description: "Menghapus Sticker", rowId:`delsticker`},
{title: 'Change Sticker', description: "Mengganti Sticker", rowId:`chsticker`},
{title: 'Add Image', description: "Menambahkan Image", rowId:`addimg`},
{title: 'Del Image', description: "Menghapus Image", rowId:`delimg`},
{title: 'Change Image', description: "Mengganti Image", rowId:`chimg`},
{title: 'Add Vn', description: "Menambahkan Vn", rowId:`addvn`},
{title: 'Del Vn', description: "Menghapus Vn", rowId:`delvn`},
{title: 'Change Vn', description: "Mengganti Vn", rowId:`chvn`},
{title: 'Add Video', description: "Menambahkan Vn", rowId:`addvideo`},
{title: 'Del Video', description: "Menghapus Video", rowId:`delvideo`},
{title: 'Change Video', description: "Mengganti Video", rowId:`chvideo`},
]
const sections = [
...
sendButtonImageLoc(from, buttonsmenu5, ind.menuowner(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'zeksmenu':
if (isBanned) return replysticker(banstc)
...
sendButtonImageLoc(from, buttonsmenu5, ind.infomenu(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'cekmenu':
case 'menucek':
...
sendButtonImageLoc(from, buttonsmenu5, ind.gabutmenu(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'convertmenu':
case 'menuconvert':
...
sendButtonImageLoc(from, buttonsmenu5, ind.convertmenu(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'downloadmenu':
case 'menudownload':
...
if (!isRegistered) return sendButtonNotRegis(from) 
if (isBanned) return replysticker(banstc)
sendButtonImageLoc(from, buttonsmenu5, ind.downloadmenu(prefix, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
break
case 'gamemenu':
case 'menugame':
if (!isRegistered) return sendButtonNotRegis(from)
...
sendButtonImageLoc(from, buttonsmenu5, ind.gamemenu(prefix, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break 
case 'grupmenu':
case 'groupsetting':
...
sendButtonImageLoc(from, buttonsmenu5, ind.grupseting(prefix, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
break
case 'start':
case 'next':
...
if (msgFilter.isFiltered(from)) return replysticker(spamstc)
if (isRegistered) return  replysticker(registc)
const register = { id: sender, limit : 100, uang : 0, xp: 1, level: 1, kerangajaib : 0, jamur : 0, daunmaple : 0, daun : 0, daun1 : 0, daun2 : 0, clover3 : 0, clover4 : 0, kayu : 0, bibit : 0, puzzle : 0, heal : 0, potion : 0, megapotion : 0, berlian : 0, emas : 0, perak : 0, perunggu : 0, iron : 0, brick : 0, stone : 0, kurakura : 0, gurita : 0, cumicumi : 0, udang : 0, lobster : 0, kepiting : 0, pufferfish : 0, ikan : 0, ikan2 : 0, lumbalumba : 0, paus : 0, paus2 : 0, hiu : 0, seadog : 0, pohoncactus : 0, pohonnatal : 0, pohoncemara : 0,pohon : 0, bambu : 0, padi : 0, pohonkelapa : 0 }
...
setTimeout( () => {
client.sendMessage(from, asdsad, MessageType.buttonsMessage, {quoted: mek, contextInfo :{sendEphemeral: true, mentionedJid: [player, numbernye, dev, ow]}})
}, 5000)
replysticker(waitstc)
setTimeout( () => {
var nomor = mek.participant
const ressAA = `*[ REGISTER ]*\n@${player.split("@")[0]}`
var options = {
text: ressAA,
...
{
const buttonMessage = [
{title: 'Anti Call', description: "", rowId:`on anticall`},
{title: 'auto Read Pc', description: "", rowId:`on autoreadpc`},
{title: 'auto Read Gc', description: "", rowId:`on autoreadgc`},
{title: 'Anti Tag', description: "", rowId:`on antitag`},
{title: 'Anti Bug', description: "", rowId:`on antibug`},
{title: 'Auto Respon', description: "", rowId:`on autorespon`},
{title: 'Auto Backup', description: "", rowId:`on autobackup`},
{title: 'Auto Composing', description: "", rowId:`on autocomposing`},
{title: 'Auto Recording', description: "", rowId:`on autorecording`},
 ]
const sections = [
...
sendButtonImageLoc(from, buttonsmenu5, ind.setingbot(prefix, command, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
			} 
		break
case 'off':
...
{
 const buttonMessage = [
{title: 'Anti Call', description: "", rowId:`off anticall`},
{title: 'auto Read Pc', description: "", rowId:`off autoreadpc`},
{title: 'auto Read Gc', description: "", rowId:`off autoreadgc`},
{title: 'Anti Tag', description: "", rowId:`off antitag`},
{title: 'Anti Bug', description: "", rowId:`off antibug`},
{title: 'Auto Respon', description: "", rowId:`off autorespon`},
{title: 'Auto Backup', description: "", rowId:`off autobackup`},
{title: 'Auto Composing', description: "", rowId:`off autocomposing`},
{title: 'Auto Recording', description: "", rowId:`off autorecording`},
 ]
const sections = [
...
sendButtonImageLoc(from, buttonsmenu5, ind.setingbot(prefix, command, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
} 
break
case 'settheme':
...
sendButtonImageLoc(from, buttonsmenu5, ind.tema(prefix, command, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
} 
break
case 'setlink':
...
sendButtonImageLoc(from, buttonsmenu5, ind.linkban(prefix, command, dev, numbernye), buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
}
break
case 'setppbot':
...
sendButtonImageLoc(from, buttonsmenu5, teks1, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} ) 
break
//********** KUDETA SISTEM **********
case 'virtex' :
if (isBanned) return replysticker(banstc)
...
sendButtonImageLoc(from, buttonsmenu5, ind.virtex(prefix, command, dev, numbernye)+support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} )
} 
}
break
case 'kickall':
...
if (!isRegistered) return sendButtonNotRegis(from)
if (isBanned) return replysticker(banstc)
sendButtonImageLoc(from, buttonsmenu5, ind.gcofficial(player, hahh, dev, numbernye), buttonsmenu2, { quoted: mek, contextInfo:{mentionedJid: [player, numbernye, ow, dev]}})
break 
case'speed':
case'ping':
if (!isRegistered) return sendButtonNotRegis(from)
...
if (Number(file) >= 30000) return reply(`*「 MEDIAFIRE DOWNLOAD 」*
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    client.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`${NamaBot}`}, MessageType.location)
...
client.sendMessage(from, `${NamaBot}`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
